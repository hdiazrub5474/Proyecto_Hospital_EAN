...
public class Medicos extends javax.swing.JFrame {
   ...
   // static ResultSet rp=null;
    ...
    void mostrarDatosMedico(String valor){
    ...
    private void initComponents() {
        ...
        BGrabarMedico = new javax.swing.JButton();
        ...
        TablaMedicos.setComponentPopupMenu(jPopupMenu1);
        TablaMedicos.setGridColor(new java.awt.Color(0, 128, 128));
        TablaMedicos.setSelectionForeground(new java.awt.Color(0, 255, 255));
        jScrollPane1.setViewportView(TablaMedicos);

        BGrabarMedico.setBackground(new java.awt.Color(0, 51, 153));
        BGrabarMedico.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        BGrabarMedico.setForeground(new java.awt.Color(255, 255, 255));
        BGrabarMedico.setText("GRABAR");
        BGrabarMedico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BGrabarMedicoActionPerformed(evt);
            }
        });
    ...
    private void BGrabarMedicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BGrabarMedicoActionPerformed
         try{
            conn=Main.Enlace(conn);
            String sqlinsertar="INSERT INTO MEDICOS VALUES(?,?,?,?,?)";
            PreparedStatement psta=conn.prepareStatement(sqlinsertar);
            psta.setString(1, TxtCedula.getText());
            psta.setString(2, TxtNombre.getText());
            psta.setString(3, TxtFecNac.getText());
            psta.setString(4, TxtEspecilidad.getText());
            psta.setString(5, TxtNacionalidad.getText());
            psta.execute();
            psta.close();
            mostrarDatosMedico("");
            ...
            this.TxtEspecilidad.setText(null);
            this.TxtNacionalidad.setText(null);
        }catch (Exception e){
            System.out.println(e.getCause());
        }
    }//GEN-LAST:event_BGrabarMedicoActionPerformed

    private void BBuscar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BBuscar1ActionPerformed
            mostrarDatosMedico(TxtBuscar.getText());
    ...
    private void BActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BActualizarActionPerformed
            try{
                conn=Main.Enlace(conn);
                String sqlupdate="UPDATE MEDICOS SET CEDULA ='"+TxtCedula.getText()+"', NOMBRE ='"+TxtNombre.getText()+"', FECNAC = '"+TxtFecNac.getText()+"', ESPECIALIDAD ='"+TxtEspecilidad.getText()+"', NACIONALIDAD='"+TxtNacionalidad.getText()+"' WHERE CEDULA='"+TxtCedula.getText()+"'";
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
            ...
            if (fila>=0)
            {
                TxtCedula.setText(TablaMedicos.getValueAt(fila, 0).toString());
                TxtNombre.setText(TablaMedicos.getValueAt(fila, 1).toString());
                TxtFecNac.setText(TablaMedicos.getValueAt(fila, 2).toString());
                TxtEspecilidad.setText(TablaMedicos.getValueAt(fila, 3).toString());
                TxtNacionalidad.setText(TablaMedicos.getValueAt(fila, 4).toString());
            }
            else
            {
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
            int fila=TablaMedicos.getSelectedRow();
            String cedula=TablaMedicos.getValueAt(fila, 0).toString();
            
            try{
                conn=Main.Enlace(conn);
                String sqldelete="DELETE FROM MEDICOS WHERE CEDULA='"+cedula+"'";
    ...
    private javax.swing.JButton BGrabarMedico;
