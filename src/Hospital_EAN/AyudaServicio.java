 ...
 * @author HUGO DIAZ
 */
public class AyudaServicio extends javax.swing.JFrame {
   ...
   // static ResultSet rp=null;
    ...
    void mostrarDatosPaciente(String valor){
        ...
        try {
            ...
            Logger.getLogger(AyudaServicio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AyudaServicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AyudaServicio().setVisible(true);
            }
        });
    }
